...
async def get_skill_endpoint(skill_name: str = "apra-underwriting"):
    """Returns the raw SKILL.md markdown text and metadata for the requested skill."""
    skill_paths = [
        os.path.join(os.path.dirname(__file__), "..", "..", "skills", "apra_underwriting", "SKILL.md"),
        os.path.join(os.path.dirname(__file__), "..", "adk", "skills", "apra_underwriting", "SKILL.md"),
        os.path.join(os.path.dirname(__file__), "skills", "apra_underwriting", "SKILL.md"),
    ]
    content = ""

                ...
                <div className="space-y-5">
                  <div className="p-4 rounded-xl bg-slate-950 border border-emerald-500/30 space-y-3 font-mono">
                    ...
                    <div className="text-xs text-slate-300 bg-slate-900/90 p-2.5 rounded-lg border border-slate-800">
                      <span className="text-purple-400">def</span> <span className="text-emerald-300 font-semibold">calculate_customer_lvr_and_serviceability</span>(<span className="text-amber-300">customer_id</span>: <span className="text-blue-300">str</span>, <span className="text-file_path">file_path</span>: <span className="text-blue-300">str</span> = <span className="text-emerald-200">"/var/sovereign/data/customer_loans.csv"</span>) -&gt; <span className="text-blue-300">Dict[str, Any]</span>:
                    </div>
